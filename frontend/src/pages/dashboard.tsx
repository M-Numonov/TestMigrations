...
const Dashboard = () => {
  ...
  const [subscription_plans, setSubscription_plans] =
  ...
  async function loadData() {
    ...
    const responseSubscription_plans = await axios.get(
    ...
    Promise.all([
      responseUsers,
      responseSubscription_plans,
      responseTransactions,
      responseCustomers,
      responseGlobal_settings,
    ])
    ...
    <>
      ...
      <SectionMain>
        ...
        <div className='grid grid-cols-1 gap-6 lg:grid-cols-3 mb-6'>
          ...
          <Link href={'/customers/customers-list'} className='mr-3'>
            <div className='rounded dark:bg-gray-900/70 bg-white border border-pavitra-400 p-6'>
              <div className='flex justify-between align-center'>
                <div>
                  <div className='text-lg leading-tight text-gray-500 dark:text-gray-400'>
