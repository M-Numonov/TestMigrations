...
import { update, fetch } from '../../stores/global_settings/global_settingsSlice'
...
const EditGlobal_settings = () => {
  ...
  useEffect(() => {
      if (typeof global_settings === 'object') {
          ...
          Object.keys(initVals).forEach(el => newInitialVal[el] = (global_settings)[el])
  ...
  return (
    <>
      ...
      <SectionMain>
        <SectionTitleLineWithButton icon={mdiChartTimelineVariant} title="Edit global_settings" main>
          Breadcrumbs
    ...
    >
        ...
        />
              ...
              <BaseButtons>
                ...
                <BaseButton type='reset' color='danger' outline label='Cancel' onClick={() => router.push('/global_settings/global_settings-list')}/>
              </BaseButtons>
            </Form>
          </Formik>
        </CardBox>
