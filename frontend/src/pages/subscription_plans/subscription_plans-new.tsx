...
import { create } from '../../stores/subscription_plans/subscription_plansSlice'
...
const TablesPage = () => {
  ...
  const handleSubmit = async (data) => {
    ...
    notify('success', 'Subscription_plans was created!')
  }
  return (
    <>
      <Head>
...
billing_cycle: '',
  ...
  <FormField label="Billing Cycle" labelFor="billing_cycle">
      <Field name="billing_cycle" id="billing_cycle" component="select">
