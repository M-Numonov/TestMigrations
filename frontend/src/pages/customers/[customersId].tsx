    ...
    >
      ...
      >
          <DatePicker
              ...
              showTimeSelect
              selected={initialValues.current_period_starts ?
                  new Date(
                      dayjs(initialValues.current_period_starts).format('YYYY-MM-DD hh:mm'),
                  ) : null
              }
              onChange={(date) => setInitialValues({...initialValues, 'current_period_starts': date})}
          />
      </FormField>
      ...
      >
          <DatePicker
              dateFormat="yyyy-MM-dd hh:mm"
              showTimeSelect
              selected={initialValues.current_period_ends ?
                  new Date(
                      dayjs(initialValues.current_period_ends).format('YYYY-MM-DD hh:mm'),
                  ) : null
              }
