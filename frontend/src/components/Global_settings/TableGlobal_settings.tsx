...
import { fetch, deleteItem } from '../../stores/global_settings/global_settingsSlice'
...
const TableSampleGlobal_settings = ({ filterItems, setFilterItems, filters }) => {
  ...
  const { global_settings, loading, count } = useAppSelector((state) => state.global_settings)
    ...
    {filterItems && filterItems.length ?
        <CardBox>
            ...
            >
                <Form>
                    <>
                        {global_settings && global_settings.map((filterItem) => {
                            return (
                                <>
      ...
      <table>
        ...
        <tbody>
          {global_settings && Array.isArray( global_settings ) &&
            global_settings.map((item: any) => (
              <tr key={item.id} onClick={() => router.push(`/global_settings/${item.id}`)}>
