...
const TableSampleSubscription_plans = ({
  filterItems,
  setFilterItems,
  filters,
}) => {
  ...
  const { subscription_plans, loading, count } = useAppSelector(
  ...
  return (
    <>
        ...
        <CardBox>
          ...
          >
            <Form>
              <>
                {subscription_plans &&
                  subscription_plans.map((filterItem) => {
                    return (
                      <>
      ...
      <table>
        ...
        <tbody>
          {subscription_plans &&
            Array.isArray(subscription_plans) &&
            subscription_plans.map((item: any) => (
              <tr
                key={item.id}
                onClick={() => router.push(`/subscription_plans/${item.id}`)}
              >
                <td data-label='name'>{item.name}</td>

                <td data-label='trial_period'>{item.trial_period}</td>

                <td data-label='billing_cycle'>{item.billing_cycle}</td>
