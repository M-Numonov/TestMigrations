...
export const deleteItem = createAsyncThunk('users/deleteUsers', async (id: string) => {
    try {
...
export const create = createAsyncThunk('users/createUsers', async (data: any) => {
...
export const update = createAsyncThunk('users/updateUsers', async (payload: any) => {
